 ...
 */
final class Version20250413123907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD user_id INT NOT NULL, DROP user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD user VARCHAR(250) DEFAULT NULL, DROP user_id');
    }
}
